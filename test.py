...
if __name__ == "__main__":
    ...
    # res_dir = ["./output/new_test/28-80/"]

    data_dir = ["./input/test/v1/28-100/", "./input/test/v1/28-90/", "./input/test/v1/28-80/", "./input/test/v1/28-70/", "./input/test/v1/28-60/",
                "./input/test/v1/40-120/", "./input/test/v1/40-100/", "./input/test/v1/40-80/",
                "./input/test/v1/35-100/", "./input/test/v1/35-80/", "./input/test/v1/35-60/",
                "./input/test/v1/25-100/", "./input/test/v1/25-80/", "./input/test/v1/25-60/",
                "./input/test/v1/20-80/", "./input/test/v1/20-60/", "./input/test/v1/20-40/"]
    res_dir = ["./output/test/28-100/", "./output/test/28-90/", "./output/test/28-80/", "./output/test/28-70/", "./output/test/28-60/",
    ...
    for data_dir_temp, res_dir_temp in zip(data_dir, res_dir):
        ...
        columns = ["RL"] + PDR
        # columns = ["GP-1", "GP-2", "GP-3", "GP-4", "GP-5"]
        ...
        df_preemption_ratio = pd.DataFrame(index=index, columns=columns)
        ...
        for name in columns:
            ...
            for prob, path in zip(index, test_paths):
                ...
                if name == "RL":
                    ...
                    with open("./output/gp/GP-%s.p" % name[-1], "rb") as file:
                ...
                while not done:
                    ...
                    if done:
                        ...
                        preemption_ratio = env.monitor.num_interrupting_actions / env.monitor.num_actions
                        break
                ...
                list_preemption_ratio.append(preemption_ratio)
            ...
            df_preemption_ratio[name] = list_preemption_ratio + [sum(list_preemption_ratio) / len(list_preemption_ratio)]
        ...
        df_preemption_ratio.to_excel(writer, sheet_name="preemption_ratio")
